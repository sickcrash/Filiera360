#!/usr/bin/env bash
# Script per riavviare i container già creati, mantenendo rete e dati
...
echo "Riavviando i container dei nodi..."
${COMPOSE_CMD} ${NETWORK_COMPOSE_FILES} restart

echo "Riavviando i container delle CA..."
${COMPOSE_CMD} ${CA_COMPOSE_FILES} restart

echo "Tutti i container sono stati riavviati."
