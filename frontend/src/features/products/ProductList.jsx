...
import DataSensors from '../products/components/DataSensors';
              ...
              <div className="card-body">
                ...
                >
                  <tbody>
                    ...
                    {product.CustomObject &&
                      product.CustomObject &&
                      Object.entries(product.CustomObject).map(([key, value]) => (
                        <tr key={key}>
                          <th>{key}</th>
                          <td>{value}</td>
                        </tr>
              ...
              <div className="card-body">
                ...
                >
                  <tbody>
                    ...
                    {batch.CustomObject &&
                      Object.entries(batch.CustomObject).map(([key, value]) => (
                        <tr key={key}>
                          <th>{key}</th>
                          <td>{value}</td>
                        </tr>
                  ...
                  <div className="card-body">
                    ...
                    >
                      <tbody>
                        ...
                        {batchProduct.CustomObject &&
                          Object.entries(batchProduct.CustomObject).map(([key, value]) => (
                            <tr key={key}>
                              <th>{key}</th>
                              <td>{value}</td>
                            </tr>
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              const response = await axios.delete(
                                `/api/unlikeProduct?productId=${likedProduct.ID}&userId=${userId}`,
                                {
                                  headers: {
                                    Authorization: `Bearer ${localStorage.getItem('token')}`,
                                    'Content-Type': 'application/json',
