...
function Certifications({ productId }) {
  ...
  useEffect(() => {
    axios
      .get(`/api/getAllCertifications?productId=${productId}`)
      .then((response) => {
                ...
                <ListGroup style={{ maxHeight: '20vw', overflowY: 'auto' }}>
                  {certifications.map((cert, index) => (
                    <ListGroup.Item key={index}>
                      <strong>Type:</strong> {cert.CertificationType || cert.certificationType}
                      <br />
                      <strong>Certifying Body:</strong> {cert.CertifyingBody || cert.certifyingBody}
                      <br />
              ...
              {productManufacturer == localStorage.getItem('manufacturer') ? (
                ...
                >
                  ...
                  <Button
                    ...
                    style={{
                      backgroundColor: showAddCertification ? 'darkgray' : '#a6d05f',
                      border: 0,
                    }}
                  >
